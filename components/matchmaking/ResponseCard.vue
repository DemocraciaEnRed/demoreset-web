...
export default {
  ...
  methods: {
    ...
    addLike () {
      ...
      this.$axios.$post(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}/like`)
        .then((res) => {
          this.$axios.$get(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}/like`)
            .then((res) => {
      ...
      // this.$axios.$post(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}/like`)
      //   .then((resPost) => {
      //     return this.$axios.$get(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}/like`)
      //   })
      //   .then((resGet) => {
    ...
    deleteComment () {
      this.$axios.$delete(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}`)
        .then((res) => {
    ...
    deleteReply (replyId) {
      this.$axios.$delete(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}/reply/${replyId}`)
        .then(async (res) => {
    ...
    editCommentModal (content) {
      this.$buefy.dialog.prompt({
        ...
        trapFocus: true,
        onConfirm: (value) => {
          this.$axios.$put(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}`, {
            content: value
          }).then(async (res) => {
            this.comment = await this.getComment()
    ...
    editReplyModal (replyId, content) {
      this.$buefy.dialog.prompt({
        ...
        trapFocus: true,
        onConfirm: (value) => {
          this.$axios.$put(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}/reply/${replyId}`, {
            content: value
          }).then(async (res) => {
            this.comment = await this.getComment()
    ...
    sendReply () {
      ...
      this.$axios.$post(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}/reply`, {
    ...
    async getComment () {
      try {
        const response = await this.$axios.$get(`/demoresetAPI/callto/${this.$route.params.id}/comment/${this.comment._id}`)
        return response
      } catch (error) {
        console.log(error)
      }

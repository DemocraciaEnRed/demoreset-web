const initiatives = {
  ...
  descriptionTab: {
    ...
    purpose: 'Purpose',
    approach: "Initiative's approach and/or solution",
    challenge: 'Problem or challenge',
    objective: 'Objetive',
  ...
  methodologyTab: {
    ...
    methodsType: 'Type of methodologies',
    methodsTechniques: 'Methodology techniques',
    participationLadder: 'Participation ladder',
  ...
  list: {
    total: 'Total of <b>{total}</b> initiatives',
    page: 'Page {page} of {totalPages}',
    nextPage: 'Next page',
    previousPage: 'Previous page',
    noResults: 'There are no initiatives for the selected filters'
  },
  tabLabels: {
